...
export default async function MainShop() {
                           ...
                           <div class="shop-product-box">
                              <div class="row">
                                 {products.map((product) => {
                                    return(
                                    <div key={product.id} class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          ...
                                          <div class="product-content">
                                             ...
                                             <h3 class="theme-title"><Link href={`/product/${product.id}`}>{product.productName}</Link></h3>
                                             
                                             <div class="product-price">
                                                <span class="price"><del>${product.originalPrice}</del> <ins>${product.discountedPrice}</ins></span>
                                             </div>
...
export async function getServerSideProps() {
   try {
     ...
     `;
      ...
      // Return fetched products as props
      return {
         props: {
            products,
         },
